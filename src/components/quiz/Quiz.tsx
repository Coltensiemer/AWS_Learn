																		...
																		<Checkbox
																			...
																			onCheckedChange={(
																				...
																				QuizContext.SET_OPTION_SELECTED(
																					{
																						[currentQuestionID]:
																							selectedValue, // Update the current question ID with the selected value
																					},
																					'checkbox'
																				);
